...
SOJ_DOCKER_RUNNER_IMAGE_GO="${SOJ_RUNNER_REGISTRY}/soj-runner-go:${SOJ_RUNNER_TAG}"
SOJ_DOCKER_RUNNER_IMAGE_CPP17="${SOJ_RUNNER_REGISTRY}/soj-runner-cpp17:${SOJ_RUNNER_TAG}"
...
boot_stack_for_slots() {
  ...
  export SOJ_RUNNER_REGISTRY
  export SOJ_RUNNER_TAG
