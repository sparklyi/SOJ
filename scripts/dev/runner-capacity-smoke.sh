...
SOJ_DOCKER_RUNNER_IMAGE_GO="${SOJ_DOCKER_RUNNER_IMAGE_GO:-soj-runner-go:local}"
SOJ_DOCKER_RUNNER_IMAGE_CPP17="${SOJ_DOCKER_RUNNER_IMAGE_CPP17:-soj-runner-cpp17:local}"
