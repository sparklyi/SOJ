...
func InitServer() *Server {
	...
	problemService := service.NewProblemService(logger, problemRepository, client)
	...
	contestRepository := repository.NewContestRepository(logger, db)
	submissionService := service.NewSubmissionService(logger, applyRepository, submissionRepository, problemRepository, languageRepository, judge, userRepository, contestRepository, client)
