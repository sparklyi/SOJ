...
const cancelPendingJudgeTaskForRejudge = `-- name: CancelPendingJudgeTaskForRejudge :one
UPDATE judge_tasks
SET status = 'done',
    stream_id = NULL,
    last_error = $1,
...
func (q *Queries) CancelPendingJudgeTaskForRejudge(ctx context.Context, arg CancelPendingJudgeTaskForRejudgeParams) (JudgeTask, error) {
	row := q.db.QueryRow(ctx, cancelPendingJudgeTaskForRejudge, arg.LastError, arg.ID)
	var i JudgeTask
	err := row.Scan(
		&i.ID,
		&i.SubmissionID,
...
const cancelQueuedRejudgeBatchItems = `-- name: CancelQueuedRejudgeBatchItems :many
...
WHERE batch_id = $2
  AND status = 'queued'
RETURNING id, batch_id, submission_id, task_id, attempt_id, status, error_message, started_at, finished_at, created_at, updated_at
`

type CancelQueuedRejudgeBatchItemsParams struct {
	ErrorMessage pgtype.Text `db:"error_message" json:"error_message"`
	BatchID      int64       `db:"batch_id" json:"batch_id"`
}

func (q *Queries) CancelQueuedRejudgeBatchItems(ctx context.Context, arg CancelQueuedRejudgeBatchItemsParams) ([]RejudgeBatchItem, error) {
	rows, err := q.db.Query(ctx, cancelQueuedRejudgeBatchItems, arg.ErrorMessage, arg.BatchID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []RejudgeBatchItem
	for rows.Next() {
		var i RejudgeBatchItem
		if err := rows.Scan(
			&i.ID,
			&i.BatchID,
			&i.SubmissionID,
...
type CountRejudgeBatchesParams struct {
...
func (q *Queries) CountRejudgeBatches(ctx context.Context, arg CountRejudgeBatchesParams) (int64, error) {
	row := q.db.QueryRow(ctx, countRejudgeBatches,
		arg.ProblemID,
		arg.ContestID,
		arg.RequestedBy,
		arg.Status,
...
const createRejudgeBatchItem = `-- name: CreateRejudgeBatchItem :one
...
type CreateRejudgeBatchItemParams struct {
	BatchID      int64 `db:"batch_id" json:"batch_id"`
	SubmissionID int64 `db:"submission_id" json:"submission_id"`
	TaskID       int64 `db:"task_id" json:"task_id"`
}

func (q *Queries) CreateRejudgeBatchItem(ctx context.Context, arg CreateRejudgeBatchItemParams) (RejudgeBatchItem, error) {
	row := q.db.QueryRow(ctx, createRejudgeBatchItem, arg.BatchID, arg.SubmissionID, arg.TaskID)
	var i RejudgeBatchItem
	err := row.Scan(
		&i.ID,
		&i.BatchID,
...
type FailActiveRejudgeBatchItemByTaskIDParams struct {
	ErrorMessage pgtype.Text `db:"error_message" json:"error_message"`
	TaskID       int64       `db:"task_id" json:"task_id"`
}

func (q *Queries) FailActiveRejudgeBatchItemByTaskID(ctx context.Context, arg FailActiveRejudgeBatchItemByTaskIDParams) (RejudgeBatchItem, error) {
	row := q.db.QueryRow(ctx, failActiveRejudgeBatchItemByTaskID, arg.ErrorMessage, arg.TaskID)
	var i RejudgeBatchItem
	err := row.Scan(
		&i.ID,
		&i.BatchID,
...
const finishRejudgeBatchItem = `-- name: FinishRejudgeBatchItem :one
UPDATE rejudge_batch_items
SET status = $1,
    error_message = $2,
    finished_at = coalesce(finished_at, now()),
...
type FinishRejudgeBatchItemParams struct {
	Status       string      `db:"status" json:"status"`
	ErrorMessage pgtype.Text `db:"error_message" json:"error_message"`
	AttemptID    pgtype.Int8 `db:"attempt_id" json:"attempt_id"`
}

func (q *Queries) FinishRejudgeBatchItem(ctx context.Context, arg FinishRejudgeBatchItemParams) (RejudgeBatchItem, error) {
	row := q.db.QueryRow(ctx, finishRejudgeBatchItem, arg.Status, arg.ErrorMessage, arg.AttemptID)
	var i RejudgeBatchItem
	err := row.Scan(
		&i.ID,
		&i.BatchID,
...
const getQueuedRejudgeBatchItemByTaskID = `-- name: GetQueuedRejudgeBatchItemByTaskID :one
...
func (q *Queries) GetQueuedRejudgeBatchItemByTaskID(ctx context.Context, taskID int64) (RejudgeBatchItem, error) {
	row := q.db.QueryRow(ctx, getQueuedRejudgeBatchItemByTaskID, taskID)
	var i RejudgeBatchItem
	err := row.Scan(
		&i.ID,
		&i.BatchID,
...
func (q *Queries) ListEligibleContestSubmissionsForRejudge(ctx context.Context, contestID pgtype.Int8) ([]Submission, error) {
	rows, err := q.db.Query(ctx, listEligibleContestSubmissionsForRejudge, contestID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListEligibleProblemSubmissionsForRejudge(ctx context.Context, problemID int64) ([]Submission, error) {
	rows, err := q.db.Query(ctx, listEligibleProblemSubmissionsForRejudge, problemID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListRejudgeBatchItems(ctx context.Context, batchID int64) ([]RejudgeBatchItem, error) {
	rows, err := q.db.Query(ctx, listRejudgeBatchItems, batchID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const listSubmissionsByCursor = `-- name: ListSubmissionsByCursor :many
SELECT id, user_id, problem_id, contest_id, language_id, testcase_set_id, status, source_artifact_id, time_ms, memory_kb, score, error_message, submitted_at, judged_at, updated_at
FROM submissions
WHERE ($1::bigint IS NULL OR user_id = $1::bigint)
  AND ($2::bigint IS NULL OR problem_id = $2::bigint)
...
func (q *Queries) ListSubmissionsByCursor(ctx context.Context, arg ListSubmissionsByCursorParams) ([]Submission, error) {
	rows, err := q.db.Query(ctx, listSubmissionsByCursor,
		arg.UserID,
		arg.ProblemID,
		arg.ContestID,
		arg.Status,
...
const prepareJudgeTaskForRejudge = `-- name: PrepareJudgeTaskForRejudge :one
UPDATE judge_tasks
SET status = 'pending',
    stream_id = NULL,
    attempts = 0,
...
func (q *Queries) PrepareJudgeTaskForRejudge(ctx context.Context, arg PrepareJudgeTaskForRejudgeParams) (JudgeTask, error) {
	row := q.db.QueryRow(ctx, prepareJudgeTaskForRejudge, arg.NextRunAt, arg.ID, arg.SubmissionID)
	var i JudgeTask
	err := row.Scan(
		&i.ID,
		&i.SubmissionID,
...
const prepareSubmissionForRejudge = `-- name: PrepareSubmissionForRejudge :one
UPDATE submissions
SET status = 'queued',
    time_ms = NULL,
    memory_kb = NULL,
...
func (q *Queries) PrepareSubmissionForRejudge(ctx context.Context, id int64) (Submission, error) {
	row := q.db.QueryRow(ctx, prepareSubmissionForRejudge, id)
	var i Submission
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
const refreshRejudgeBatchProgress = `-- name: RefreshRejudgeBatchProgress :one
WITH counts AS (
...
RETURNING rejudge_batches.id, rejudge_batches.problem_id, rejudge_batches.contest_id, rejudge_batches.requested_by, rejudge_batches.status, rejudge_batches.reason, rejudge_batches.filters, rejudge_batches.total_count, rejudge_batches.completed_count, rejudge_batches.failed_count, rejudge_batches.canceled_count, rejudge_batches.error_message, rejudge_batches.started_at, rejudge_batches.finished_at, rejudge_batches.created_at, rejudge_batches.updated_at
`

func (q *Queries) RefreshRejudgeBatchProgress(ctx context.Context, id int64) (RejudgeBatch, error) {
	row := q.db.QueryRow(ctx, refreshRejudgeBatchProgress, id)
	var i RejudgeBatch
	err := row.Scan(
		&i.ID,
		&i.ProblemID,
...
const restoreSubmissionAfterCanceledRejudge = `-- name: RestoreSubmissionAfterCanceledRejudge :one
UPDATE submissions
...
func (q *Queries) RestoreSubmissionAfterCanceledRejudge(ctx context.Context, submissionID int64) (Submission, error) {
	row := q.db.QueryRow(ctx, restoreSubmissionAfterCanceledRejudge, submissionID)
	var i Submission
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
const startRejudgeBatchItem = `-- name: StartRejudgeBatchItem :one
UPDATE rejudge_batch_items
SET status = 'running',
    attempt_id = $1,
    started_at = coalesce(started_at, now()),
...
type StartRejudgeBatchItemParams struct {
	AttemptID pgtype.Int8 `db:"attempt_id" json:"attempt_id"`
	ID        int64       `db:"id" json:"id"`
}

func (q *Queries) StartRejudgeBatchItem(ctx context.Context, arg StartRejudgeBatchItemParams) (RejudgeBatchItem, error) {
	row := q.db.QueryRow(ctx, startRejudgeBatchItem, arg.AttemptID, arg.ID)
	var i RejudgeBatchItem
	err := row.Scan(
		&i.ID,
		&i.BatchID,
